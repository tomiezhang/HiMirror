...
export class Weather extends React.Component {
	...
	componentDidMount(){
		$.get("http://op.juhe.cn/onebox/weather/query?cityname=%E5%8C%97%E4%BA%AC&dtype=json&key=4db15a544a32ba0d379af01e129725ab",function( data ){
			console.log( data );
		});
	}
	render() {
		return (
			<div className="mod weather">
				<div className="hd">
					...
					<p>28°C</p><span className="AIQ">149中度污染</span>
				</div>
				<div className="bd">
					<ul>
						<li className="info">20日&nbsp;&nbsp;<img height="32" src="http://www.heweather.com/weather/images/icon/101.png"/>&nbsp;&nbsp;27°C&nbsp;&nbsp;微风</li>
						<li className="info">20日&nbsp;&nbsp;<img height="32"  src="http://www.heweather.com/weather/images/icon/100.png"/>&nbsp;&nbsp;27°C&nbsp;&nbsp;微风</li>
						<li className="info">20日&nbsp;&nbsp;<img height="32"  src="http://www.heweather.com/weather/images/icon/103.png"/>&nbsp;&nbsp;27°C&nbsp;&nbsp;微风</li>
					</ul>
				</div>
				<div className="ft">
